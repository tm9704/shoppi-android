...
class CategoryTopSellingSectionAdaptor : ListAdapter<TopSelling, CategoryTopSellingSectionAdaptor.TopSellingSectionViewHolder>(TopSellingDiffCallback()){
    ...
    class TopSellingSectionViewHolder(private val binding: ItemCategoryTopSellingSectionBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        private val nestedAdapter = CategoryTopSellingItemAdaptor()
